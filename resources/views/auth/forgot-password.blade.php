    ...
    <main class="w-full flex-grow">
        <div class="w-full flex flex-col items-center justify-center py-8 px-4 sm:px-6 lg:px-8">
            ...
            <div class="max-w-[480px] w-full p-6 sm:p-8 rounded-md bg-white border border-gray-300 shadow-sm z-10">
                <h1 class="text-[#3E5641] text-center text-2xl font-bold font-playfair mb-2 uppercase">FORGOT PASSWORD</h1>
                ...
                <form method="POST" action="{{ route('password.email') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative flex items-center">
                            <input name="email" type="email" required value="{{ old('email') }}" autofocus autocomplete="username"

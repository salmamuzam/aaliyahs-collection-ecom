        ...
        <div class="max-w-4xl w-full p-6 sm:p-10 brand-card z-10">
            ...
            <form method="POST" action="{{ route('register') }}" novalidate class="space-y-6">
                ...
                <div class="grid gap-4 sm:grid-cols-2">
                    <x-shared.form.input label="First Name" name="first_name" required :value="old('first_name')" autofocus autocomplete="first_name" placeholder="Enter first name">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" />
                        </svg>
                    </x-form.input>

                    <x-shared.form.input label="Last Name" name="last_name" required :value="old('last_name')" autocomplete="last_name" placeholder="Enter last name">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" />
                        </svg>
                    </x-form.input>
                ...
                {{-- Username & Email --}}
                <div class="grid gap-4 sm:grid-cols-2">
                    <x-shared.form.input label="Username" name="username" required :value="old('username')" autocomplete="username" placeholder="Enter username">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M16.5 12a4.5 4.5 0 1 1-9 0 4.5 4.5 0 0 1 9 0Zm0 0c0 1.657 1.007 3 2.25 3S21 13.657 21 12a9 9 0 1 0-2.636 6.364M16.5 12V8.25" />
                        </svg>
                    </x-form.input>

                    <x-shared.form.input label="Email" name="email" type="email" required :value="old('email')" autocomplete="username" placeholder="Enter email">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                ...
                <div class="grid gap-4 sm:grid-cols-2">
                    ...
                    <x-shared.form.password-input label="Confirm Password" name="password_confirmation" required autocomplete="new-password" placeholder="Confirm password" />
                </div>

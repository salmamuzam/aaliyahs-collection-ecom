<nav id="sidebar" class="bg-brand-teal h-screen fixed top-0 left-0 min-w-[260px] pt-12 pb-6 px-4 flex flex-col overflow-auto z-50 transform -translate-x-full lg:translate-x-0 transition-transform duration-300">
    <div class="flex flex-col flex-wrap items-center justify-center cursor-pointer">
        ...
        <div class="mt-4 text-center">
            ...
            <p class="text-[15px] text-white italic mt-0.5"> {{ Auth::user()->email}}</p>
        </div>
    </div>
        ...
        <li>
            <form method="POST" action="{{ route('logout') }}" x-data>
                ...
                <a href="{{ route('logout') }}"
                    ...
                    class="text-white text-[17px] font-normal flex items-center hover:bg-brand-burgundy rounded px-4 py-2 transition-all">
                    <div class="mr-3.5 w-[22px] h-[22px]">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-full h-full" viewBox="0 0 6.35 6.35">

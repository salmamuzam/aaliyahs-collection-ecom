...
<x-dialog-modal wire:model.live="confirmingPassword">
    ...
    <x-slot name="content">
        ...
        <div class="mt-4" x-data="{ show: false }" x-on:confirming-password.window="setTimeout(() => $refs.confirmable_password.focus(), 250)">
            <div class="relative">
                <x-input class="mt-1 block w-full pr-10" 
                ...
                <div @click="show = !show" class="absolute top-1/2 right-3 transform -translate-y-1/2 cursor-pointer text-[#bbb] hover:text-[#3E5641] transition-colors">

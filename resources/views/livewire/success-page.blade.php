          ...
          <div class="max-w-6xl mx-auto max-lg:max-w-2xl">
              ...
              <div class="grid mt-12 lg:grid-cols-3 gap-y-16">
                  <div class="lg:border-r lg:border-gray-300 lg:pr-8">
                      <div>
                          <h3 class="mb-6 text-base font-semibold text-slate-900">Shipping Information</h3>
                          <div class="grid sm:grid-cols-2 gap-x-4 gap-y-6">
                              <div>
                                  <p class="text-sm font-medium text-slate-500">Customer</p>
                                  <p class="mt-2 text-sm font-medium text-slate-900">Alex Johnson</p>
                              </div>
                              <div>
                              ...
                              <div>
                                  ...
                                  <p class="mt-2 text-sm font-medium text-slate-900">425 Park Avenue, San Francisco, CA 94107</p>
                              </div>
                              <div>
                                  <p class="text-sm font-medium text-slate-500">Phone</p>
                                  <p class="mt-2 text-sm font-medium text-slate-900">(555) 123-4567</p>
                              </div>
                          </div>
                      </div>

                      <div class="mt-12">
                          <h3 class="mb-6 text-base font-semibold text-slate-900">Billing details</h3>
                  ...
                  <div class="space-y-4 lg:col-span-2 lg:pl-8 max-lg:-order-1">
                      <div class="space-y-4 lg:col-span-2">
                          <div class="grid items-center gap-4 sm:grid-cols-3">
                              <div class="flex items-center col-span-2 gap-4">
                                  <div class="p-2 bg-gray-100 rounded-md w-28 h-28 max-sm:w-24 max-sm:h-24 shrink-0">
                                      <img src='https://readymadeui.com/images/product14.webp' class="object-contain w-full h-full" />
                                  </div>
                                  <div>
                              ...
                              <div class="sm:ml-auto">
                                  <h4 class="text-base font-semibold sm:text-lg text-slate-900">$20.00</h4>
                              </div>
                          </div>
                          ...
                          <div class="grid items-center gap-4 sm:grid-cols-3">
                              <div class="flex items-center col-span-2 gap-4">
                                  <div class="p-2 bg-gray-100 rounded-md w-28 h-28 max-sm:w-24 max-sm:h-24 shrink-0">
                                      <img src='https://readymadeui.com/images/watch5.webp' class="object-contain w-full h-full" />
                                  </div>
                                  <div>
                              ...
                              <div class="sm:ml-auto">
                                  <h4 class="text-base font-semibold sm:text-lg text-slate-900">$60.00</h4>
                              </div>
                          </div>
                          ...
                          <div class="grid items-center gap-4 sm:grid-cols-3">
                              <div class="flex items-center col-span-2 gap-4">
                                  <div class="p-2 bg-gray-100 rounded-md w-28 h-28 max-sm:w-24 max-sm:h-24 shrink-0">
                                      <img src='https://readymadeui.com/images/watch4.webp' class="object-contain w-full h-full" />
                                  </div>
                                  <div>
                              ...
                              <div class="sm:ml-auto">
                                  <h4 class="text-base font-semibold sm:text-lg text-slate-900">$40.00</h4>
                              </div>
                          </div>
                      </div>
                  </div>

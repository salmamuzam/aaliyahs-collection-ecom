<tr class="bg-white">
    <td class="p-3 text-sm text-center text-gray-700 whitespace-nowrap">
        <img class="h-auto rounded-lg w-100" src="{{ asset('storage/' . $category->image) }}">
    </td>
    <td class="p-3 text-sm text-center text-gray-700 whitespace-nowrap">
        {{ $category->name }}
    </td>
    <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap">
        <div class="flex items-center space-x-4">
            ...
            <button wire:click="deleteCategory({{ $category->id }})" wire:confirm="Are you sure, you want to delete?"
                type="button" data-modal-target="delete-modal" data-modal-toggle="delete-modal"

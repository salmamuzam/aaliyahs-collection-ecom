        ...
        <div class="p-6 mx-auto max-w-7xl max-lg:max-w-4xl">
            ...
            <div class="relative grid gap-4 mt-6 lg:grid-cols-3">
                <div class="space-y-4 lg:col-span-2">
                    <div class="relative p-6 bg-white border border-gray-300 rounded-md shadow-sm">
                        <div class="flex items-center gap-4 max-sm:flex-col max-sm:gap-6">
                            <div class="w-52 h-52 shrink-0">
                                <img src='https://readymadeui.com/images/laptop2.webp'
                                    class="object-contain w-full h-full" />
                            </div>
                            <div class="w-full sm:border-l sm:pl-4 sm:border-gray-300">
                                <h3 class="text-base font-semibold text-slate-900">HP ProBook 455 (15.6) 39.6 cm G9
                                    Business Laptop</h3>
                                <ul class="mt-4 space-y-2 text-sm font-medium text-slate-500">
                                    <li>AMD Ryzen™ 5 processor</li>
                                    <li>FreeDOS</li>
                                    <li>16 GB DDR4 RAM</li>
                                    <li>512 GB PCIe® NVMe™ SSD Hard Drive</li>
                                    <li><a href="javascript:void(0);" class="text-blue-600">(See more
                                            Specifications)</a></li>
                                </ul>
                                ...
                                <div class="flex flex-wrap items-center justify-between gap-4">
                                    <div class="flex items-center gap-4">
                                        ...
                                        <span class="font-semibold text-base leading-[16px]">2</span>
                                        <button type="button"
                                            class="flex items-center justify-center w-[18px] h-[18px] bg-blue-600 outline-none rounded-sm cursor-pointer">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-2 fill-white"
                                                viewBox="0 0 42 42">
                                    ...
                                    <div class="flex items-center">
                                        <h4 class="text-base font-semibold text-slate-900">$1020.00</h4>
                    ...
                    <div class="relative p-6 bg-white border border-gray-300 rounded-md shadow-sm">
                        <div class="flex items-center gap-4 max-sm:flex-col max-sm:gap-6">
                            <div class="w-52 h-52 shrink-0">
                                <img src='https://readymadeui.com/images/laptop4.webp'
                                    class="object-contain w-full h-full" />
                            </div>
                            <div class="w-full sm:border-l sm:pl-4 sm:border-gray-300">
                                <h3 class="text-base font-semibold text-slate-900">ThinkPad E16 40.64cms - 13th Gen
                                    Intel i5</h3>
                                <ul class="mt-4 space-y-2 text-sm font-medium text-slate-500">
                                    <li>AMD Ryzen™ 5 processor</li>
                                    <li>FreeDOS</li>
                                ...
                                <div class="flex flex-wrap items-center justify-between gap-4">
                                    ...
                                    <div class="flex items-center">
                                        <h4 class="text-base font-semibold text-slate-900">$1100.00</h4>
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            class="w-3 cursor-pointer shrink-0 fill-gray-400 hover:fill-red-500 absolute top-3.5 right-3.5"
                                            viewBox="0 0 320.591 320.591">
                                            <path
                ...
                <div class="sticky top-0 p-6 bg-white border border-gray-300 rounded-md shadow-sm h-max">
                    ...
                    <ul class="mt-4 text-sm font-medium divide-y divide-gray-300 text-slate-500">
                        <li class="flex flex-wrap gap-4 py-3">Subtotal <span
                                class="ml-auto font-semibold text-slate-900">$2120.00</span></li>

        ...
        <div class="p-6 mx-auto max-w-7xl max-lg:max-w-4xl">
            ...
            <div class="relative grid gap-4 mt-6 lg:grid-cols-3">
                <div class="space-y-4 lg:col-span-2">
                    ...
                    <div wire:key="{{ $item['product_id'] }}" class="relative p-6 bg-white border border-gray-300 rounded-md shadow-sm">
                        <div class="flex items-center gap-4 max-sm:flex-col max-sm:gap-6">
                            <div class="w-52 h-52 shrink-0">
                                <img src='{{ url('storage', $item['image']) }}'
                                    class="object-contain w-full h-full" alt="{{ $item['name'] }}" />
                            </div>
                            <div class="w-full sm:border-l sm:pl-4 sm:border-gray-300">
                                ...
                                <div class="flex flex-wrap items-center justify-between gap-4">
                                    ...
                                    <div class="flex items-center">
                                        <h4 class="text-base font-semibold text-slate-900"> LKR {{ $item['unit_amount'] }}</h4>
                                ...
                                <div class="mt-6">
                                 <span class="font-semibold text-base text-red-600 leading-[16px]">Total: LKR {{ $item['total_amount'] }}</span>
                           </div>
                                </div>

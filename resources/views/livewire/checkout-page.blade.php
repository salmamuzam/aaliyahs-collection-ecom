                        ...
                        <div class="mt-10">
                            ...
                            <div class="flex gap-4 mt-8 max-lg:flex-col">
                                <button type="button"
                                    ...
                                    Shopping</button>
                                <button type="button"
                                    class="rounded-md px-4 py-2.5 w-full text-sm font-medium tracking-wide bg-blue-600 hover:bg-blue-700 text-white cursor-pointer">Complete
                                    Purchase</button>
                            </div>
                        </div>
                    </form>
    ...
    <div class="flex items-center gap-4 max-sm:flex-col">
        ...
        <div class="flex justify-between w-full gap-4">
            <div>
                ...
                <h6 class="text-[15px] text-slate-900 font-semibold mt-4">LKR {{ $ci['total_amount'] }}</h6>
            </div>
            <div class="flex flex-col items-end justify-between gap-4">
                ...
                <div class="flex items-center px-2.5 py-1.5 border border-gray-400 text-slate-900 text-xs font-medium bg-transparent rounded-md">
                            ...
                            <div>
                                <ul class="space-y-4 font-medium text-slate-500">
                                    <li class="flex flex-wrap gap-4 text-sm">Subtotal <span
                                            class="ml-auto font-semibold text-slate-900">Rs. {{ $grand_total }}</span>
                                    </li>
                                    <li class="flex flex-wrap gap-4 text-sm">Shipping <span
                                            class="ml-auto font-semibold text-slate-900">Rs.0.00</span></li>
                                    ...
                                    <li class="flex flex-wrap gap-4 text-[15px] font-semibold text-slate-900">Total
                                        <span class="ml-auto">Rs. {{ $grand_total }}</span></li>
                                </ul>
                            </div>
                        </div>
                    </div>

                ...
                <div class="w-full max-w-4xl rounded-md h-max">
                    <form wire:submit.prevent="placeOrder">
                        ...
                        <div class="mt-10">
                            ...
                            <div class="flex flex-wrap mt-4 mb-2 gap-y-6 gap-x-12">
                                ...
                                @foreach ($cart_items as $ci)
                                    <div class="flex items-center gap-4 max-sm:flex-col">
                                        ...
                                        <div class="flex justify-between w-full gap-4">
                                            <div>
                                                <h3 class="text-sm font-medium text-slate-900">{{ $ci['name'] }}
                                                </h3>
                                            ...
                                            <div class="flex flex-col items-end justify-between gap-4">
                                                <div>
                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                        class="inline w-4 cursor-pointer fill-red-500"
                                                        viewBox="0 0 24 24">
                                                        <path
                            ...
                            <div>
                                <ul class="space-y-4 font-medium text-slate-500">
                                    <li class="flex flex-wrap gap-4 text-sm">Subtotal <span
                                            class="ml-auto font-semibold text-slate-900">LKR.
                                            {{ $grand_total }}</span>
                                    </li>

                        ...
                        <div class="mt-10">
                            ...
                            <div class="flex flex-wrap mt-4 mb-8 gap-y-6 gap-x-12">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <label for="paypal" class="flex gap-2 ml-4 cursor-pointer">
                            ...
                            <div class="grid lg:grid-cols-2 gap-y-6 gap-x-4">
                                <div>
                                    <label class="block mb-2 text-sm font-medium text-slate-900">Cardholder's Name</label>
                        ...
                        <div class="px-6 py-8 md:overflow-auto">
                            <div class="space-y-4">
                                <div class="flex gap-4 max-sm:flex-col">
                                    <div class="w-24 h-24 p-2 rounded-md shrink-0 bg-purple-50">
                                    ...
                                    <div class="flex justify-between w-full gap-4">
                                        <div>
                                            ...
                                            <p class="mt-2 text-sm font-medium text-slate-500">Black/White</p>
                                            <h6 class="text-[15px] text-slate-900 font-semibold mt-4">$18.00</h6>
                                        </div>
                                        <div class="flex flex-col items-end justify-between gap-4">
                                            <div>
                                                <svg xmlns="http://www.w3.org/2000/svg" class="inline w-4 cursor-pointer fill-red-500" viewBox="0 0 24 24">
                                ...
                                <div class="flex gap-4 max-sm:flex-col">
                                    ...
                                    <div class="flex justify-between w-full gap-4">
                                        <div>
                                            ...
                                            <p class="mt-2 text-sm font-medium text-slate-500">Gray</p>
                                ...
                                <div class="flex gap-4 max-sm:flex-col">
                                    <div class="w-24 h-24 p-2 rounded-md shrink-0 bg-purple-50">
                                        <img src='https://readymadeui.com/images/dark-green-tshirt-2.webp' class="object-contain w-full h-full" />
                                    </div>
                                    <div class="flex justify-between w-full gap-4">
                                        <div>
                                            <h3 class="text-sm font-medium text-slate-900">T-shirt</h3>
                                            <p class="mt-2 text-sm font-medium text-slate-500">Dark Green</p>

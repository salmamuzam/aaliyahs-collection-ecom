<div class="h-screen p-5">
    ...
    @if(session('success'))
        <div class="flex items-center w-full p-4 mb-2 font-semibold tracking-wide text-white rounded-md shadow-md bg-emerald-500 min-w-xs shadow-green-100"
            role="alert">
    ...
    @elseif(session('error'))
        <div class="flex items-center w-full p-4 mb-2 font-semibold tracking-wide text-white rounded-md shadow-md bg-rose-500 min-w-xs shadow-red-100"
            role="alert">
            <div class="mr-3 shrink-0">
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 md:hidden">
        <div class="p-4 space-y-3 bg-white rounded-lg shadow">
            <div class="flex items-center space-x-2 text-sm">
                ...
                <div>
                    <span
                        class="p-1.5 text-xs font-medium uppercase tracking-wider text-pink-800 bg-pink-200 rounded-lg bg-opacity-50">Delivered</span>
                </div>
            </div>

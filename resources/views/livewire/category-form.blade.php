<div class="max-w-6xl mx-auto py-8 px-4">
    <div class="bg-white border border-gray-300 rounded-md shadow-sm p-6 sm:p-10">
        <div class="mb-8 flex items-center justify-between">
            ...
            <a wire:navigate href="{{ route('categories') }}" class="px-5 py-2.5 text-base font-semibold text-white bg-[#3E5641] rounded-lg hover:bg-[#2F4232] transition-colors shadow-sm">
                Back
            </a>
        </div>

        <form wire:submit="saveCategory" class="grid sm:grid-cols-2 gap-4 text-[#1A1A1A]">
            {{-- Name Input --}}

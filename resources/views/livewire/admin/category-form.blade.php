<div class="pt-24 pb-8 brand-container lg:pt-8">
    <div class="p-6 brand-card sm:p-10">
        <div class="flex items-center justify-between mb-8">
            <h2 class="text-2xl text-brand-teal brand-heading-playfair">
                {{ $isView ? 'View' : ($category ? 'Edit' : 'Create') }} Category
            </h2>
            <a wire:navigate href="{{ route('admin.categories') }}" class="px-5 py-2.5 text-base font-semibold text-white bg-brand-green rounded-lg hover:bg-opacity-90 transition-colors shadow-sm">
                Back
            </a>
        </div>

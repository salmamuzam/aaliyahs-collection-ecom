<div class="px-6 lg:px-12 pt-6 lg:pt-10 pb-4 lg:pb-8">
    ...
    <div class="hidden md:block overflow-hidden brand-card">
        ...
        <div class="divide-y divide-gray-200">
            @foreach(range(1, 4) as $i)
                <div class="p-4 flex gap-6 items-center h-24">
                    <div class="w-12 h-16 bg-gray-200 animate-pulse rounded"></div>
    ...
    <div class="md:hidden grid grid-cols-2 gap-4">
        @foreach(range(1, 4) as $i)
            <div class="brand-card p-2 space-y-3">
                <div class="aspect-[3/4] bg-gray-200 animate-pulse rounded-md"></div>

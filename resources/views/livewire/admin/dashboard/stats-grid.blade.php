<div class="grid lg:grid-cols-4 sm:grid-cols-2 gap-x-6 gap-y-6 lg:max-w-full mx-auto">
    ...
    {{-- Total Categories --}}
    <x-admin.dashboard.stats-card :href="route('admin.categories')" :count="$totalCategories" label="Categories">
    ...
    {{-- Total Products --}}
    <x-admin.dashboard.stats-card :href="route('admin.products')" :count="$totalProducts" label="Products">
    ...
    {{-- Total Orders --}}
    <x-admin.dashboard.stats-card :href="route('admin.orders')" :count="$totalOrders" label="Orders">
     ...
     {{-- Total Customers --}}
    <x-admin.dashboard.stats-card href="#" :count="$totalCustomers" label="Customers">
        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-12 h-12 text-brand-teal" viewBox="0 0 24 24">
